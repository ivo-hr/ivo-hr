(function () {
    ...
    var translations = {
        es: {
            ...
            "cv.teacherText": "Impartición de <strong>programación, robótica y diseño en español e inglés</strong>, adaptando contenidos a distintos niveles. Refuerzo de la <strong>comunicación técnica</strong>, resolución de dudas y seguimiento del aprendizaje. Planificación de sesiones, materiales y objetivos a corto y medio plazo.",
            "cv.oubitaTitle": "Diseñador de Metaverso - Oubita",
            "cv.oubitaDate": "Febrero 2022 - Octubre 2022 | Alcobendas, España",
            "cv.oubitaText": "<strong>Programación, integración y despliegue de entornos virtuales multiplataforma</strong>. Optimización de modelos y rendimiento para asegurar estabilidad, junto con <strong>control de versiones</strong>, preparación de demos técnicas y validación de requisitos.",
            ...
            "cv.freelanceText": "<strong>Montaje, optimización, diagnóstico y mantenimiento</strong> de ordenadores y electrónica de consumo. Resolución de incidencias de <strong>hardware, redes básicas y sistemas operativos</strong>, con aprendizaje continuo mediante documentación técnica.",
            ...
            "cv.degreeText": "<strong>Universidad Complutense de Madrid, Facultad de Informática.</strong> Trabajo Fin de Grado: <strong>LLMAttorney</strong>, proyecto de creación y simulación de casos jurídicos con LLMs presentado por la UCM en el <strong>V Congreso Español de Videojuegos 2026</strong>.",
            ...
            "cv.devopsSystemsText": "Git | GitHub | GitLab | Docker | Linux | Redes | Diagnóstico de hardware",
            "cv.methodologiesTitle": "Metodologías",
            "cv.methodologiesText": "Scrum | Agile | Kanban | Gestión de riesgos | Documentación técnica",
        ...
        en: {
            ...
            "cv.qubiqText": "<strong>Development and integration of solutions built on Odoo</strong> with <strong>Python, JavaScript and XML</strong>. <strong>Functional analysis, gap analysis and requirements definition</strong>, workflow design and process modelling. Feature development, issue resolution and technical documentation. Contribution to <strong>DevOps and Cloud DevOps</strong> tasks, deployment automation and delivery process improvement using the agile <strong>QGo</strong> methodology.",
            ...
            "cv.teacherText": "Delivery of <strong>programming, robotics and design lessons in Spanish and English</strong>, adapting content to different ability levels. Strengthening <strong>technical communication</strong>, answering questions and monitoring learning. Planning sessions, materials and short- and medium-term objectives.",
            "cv.oubitaTitle": "Metaverse Designer - Oubita",
            "cv.oubitaDate": "February 2022 - October 2022 | Alcobendas, Spain",
            "cv.oubitaText": "<strong>Programming, integration and deployment of cross-platform virtual environments</strong>. Model and performance optimisation to ensure stability, alongside <strong>version control</strong>, technical demo preparation and requirements validation.",
            ...
            "cv.freelanceText": "<strong>Assembly, optimisation, diagnostics and maintenance</strong> of computers and consumer electronics. Troubleshooting <strong>hardware, basic networking and operating-system issues</strong>, with continuous learning through technical documentation.",
            ...
            "cv.degreeText": "<strong>Complutense University of Madrid, Faculty of Computer Science.</strong> Final-year dissertation: <strong>LLMAttorney</strong>, a project for creating and simulating legal cases with LLMs, presented by UCM at the <strong>5th Spanish Video Games Conference 2026</strong>.",
            ...
            "cv.devopsSystemsText": "Git | GitHub | GitLab | Docker | Linux | Networking | Hardware diagnostics",
            "cv.methodologiesTitle": "Methodologies",
            "cv.methodologiesText": "Scrum | Agile | Kanban | Risk management | Technical documentation",
            "cv.toolsTitle": "Tools",
